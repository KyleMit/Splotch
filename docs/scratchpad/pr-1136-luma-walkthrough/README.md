...
Review-only artifacts for the "Centralize asset luma conventions" PR. Nothing here is wired into
the build; the branch exists so the figures have a stable raw URL for the PR comment.
