...
for (const f of picks) {
  ...
  tiles.push(
    await stack([
      ...
      svgLabel(TILE, 20, [`q92 ${d92.dirtyPct.toFixed(1)}% -> q90 ${d90.dirtyPct.toFixed(1)}%`], {
        size: 12,
        weight: 500,
        fg: d90.dirtyPct > d92.dirtyPct * 1.5 ? '#991b1b' : '#6b7280',
      }),
    ])
  );
    ...
    [
      svgLabel(
        ...
        [
          title,
          {
            t: '% = share of paper-next-to-ink pixels the encoder dirties',
            size: 14,
            weight: 400,
            fg: '#6b7280',
          },
