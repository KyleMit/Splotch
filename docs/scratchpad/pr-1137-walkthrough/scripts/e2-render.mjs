...
const cells = [
  await stack([
    svgLabel(
      WIN * ZOOM,
      60,
      ['the art', { t: 'black ink, white paper', size: 15, weight: 400, fg: '#6b7280' }],
      { size: 19 }
    ),
    ...
    await stack([
      svgLabel(
        ...
        [
          `q${q}`,
          {
            t: `${stat.dirtyPct.toFixed(1)}% of paper dirtied · worst ${stat.worst}/255 · ${(enc.length / 1024).toFixed(0)} KB`,
            size: 15,
            weight: 400,
            fg: '#6b7280',
          },
