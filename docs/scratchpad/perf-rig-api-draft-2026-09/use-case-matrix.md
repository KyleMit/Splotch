...
| `perf:device:verify-android`                         | preflight  | android-split             | `verifyInput`                                                  | gesture plan                                                                                           |
| `perf:device:verify-android-rotation`                | preflight  | android-split             | `verifyRotation`                                               |                                                                                                        |
| `perf:device:probe-overhead`                         | diagnostic | android-split             | `probeOverhead`                                                |                                                                                                        |
...
| `perf:analyze:frames` / `:chrome` / `:web-inspector` | analysis   | —                         | `analyzeFrames` / `analyzeChromeTrace` / `analyzeWebInspector` | measure-name narration                                                                                 |
