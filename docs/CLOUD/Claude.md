...
the full working tree — printing a loud line into context instead of dying silently. That command is
also the manual recovery if `node_modules` ever turns up empty or half-installed.
