...
| `screen.orientation.angle` (+ `change` event) | `lib/drawing/engine.ts` (paper view, ADR-0048) | Chrome 38 / Safari 16.4 | ✅ `?.` falls back to angle 0 | rotation treated as a plain resize — drawing anchors top-left as before the feature |
