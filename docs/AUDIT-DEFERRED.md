...
Implemented the scoped shared ring-geometry properties and all allowed checks pass, but the sandbox
denied creating `.git/index.lock`, so I could not commit the change.
