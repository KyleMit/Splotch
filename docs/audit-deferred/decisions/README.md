...
| -- | -------------------------------------------------------------- | -------- | ------------------------------------------------------------------ | ------- |
| 1  | `--check` flag parsing ad hoc in every gate script             | P4       | [check-flag-parsing.md](check-flag-parsing.md)                     | pending |
...
| 9  | Git version derivation embedded untestable in `vite.config.ts` | P3       | [git-version-derivation.md](git-version-derivation.md)             | pending |
| 10 | `CAPACITOR` single signal re-derived in every config           | P3       | [capacitor-single-signal.md](capacitor-single-signal.md)           | pending |
| 11 | `android:allowBackup="true"` unexplained for a kids app        | P4       | [android-allowbackup.md](android-allowbackup.md)                   | pending |
| 12 | npm@11 pin rationale copy-pasted across four shell files       | P2       | [npm11-pin-rationale.md](npm11-pin-rationale.md)                   | pending |
