...
> action-first page-inventory commands may span namespaces instead of living under `gen:*`, while
> the npm catalog and same-change `scripts-info` documentation rules remain in force.
