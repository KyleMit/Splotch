...
| `workbox.globIgnores`       | social card, generator inputs/source line art, and responsive coloring tiers      | Avoids caching served assets the app never fetches and duplicate resolutions of the same coloring art                       |
