...
| [0085](0085-tiled-live-canvas-for-ipad-webkit.md)          | Tile the Full-Resolution Live Canvas to Avoid WebKit Surface-Flush Starvation    | Active (supersedes [0066](0066-snapshot-undo-reinstated.md), [0068](0068-crayon-raster-pass-commit.md), [0069](0069-dirty-rect-patch-snapshots.md), [0074](0074-undo-hotpath-patch-capture-optimizations.md), and [0082](0082-resident-snapshot-tier-byte-budget.md) for production) |
