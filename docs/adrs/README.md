...
| [0032](0032-performance-profiling-harness.md)                         | Automated Performance Profiling Harness (build-flag marks + CDP/WebKit capture, web + Android + iOS)      | Active (amended by [0066](0066-snapshot-undo-reinstated.md), [0079](0079-physical-ios-device-capture-webkit-inspector-protocol.md), [0083](0083-real-screen-capture-on-device.md), [0084](0084-trusted-xcuitest-input-for-ipad-real-screen-profiling.md)) |
