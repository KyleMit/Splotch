...
| [0078](0078-playwright-worker-count-and-flake-tuning.md)    | Playwright Worker Count Is Measured, Not Assumed                                                          | Active (partly superseded by [0079](0079-committed-brush-mode-seam-and-paced-strokes.md)) |
| [0079](0079-committed-brush-mode-seam-and-paced-strokes.md) | Tests Observe the Engine's Committed Brush Mode, and Pace Their Own Strokes                               | Active (amends [0078](0078-playwright-worker-count-and-flake-tuning.md))                  |
