...
describe('coloringPackResolutionForScreen', () => {
  it.each([
    [{ widthCssPx: 375, heightCssPx: 667, devicePixelRatio: 3 }, 'compact'],
    [{ widthCssPx: 430, heightCssPx: 932, devicePixelRatio: 3 }, 'compact'],
  ...
  it('is orientation-independent', () => {
    const portrait = { widthCssPx: 430, heightCssPx: 932, devicePixelRatio: 3 };
