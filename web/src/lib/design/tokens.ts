...
// (tools/tokens/gen-token-css.mjs) — camelCase keys become kebab-case custom
...
export const zIndex = {
  ...
  zRailGlass: 999, // Bare palette glass and its margin rules cover the accept ring as the Buttons palette does
  zClearButton: 1000,
