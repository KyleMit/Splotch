...
// whether the crayon lifted before re-covering a spot. When the tip re-covers
// its own laid strip (detected by CrayonPassTracker in crayonPassTracker.ts),
// the engine starts a new pass there by bumping to a fresh seed for the ops
// that follow. The new phase punches its pits in different paper
