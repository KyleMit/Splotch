...
<BetaStepLedger>
  ...
  >
    {#snippet body()}
      TestFlight is Apple's app for installing prerelease versions of apps. Install it from the App
      Store on the iPhone or iPad where you'd like to try Splotch.
    {/snippet}
    {#snippet cardBody()}
