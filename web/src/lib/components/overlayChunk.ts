...
// module at idle so their code never loads — and their subtrees never hydrate —
// inside the first-load long task; most then mount one per idle callback, while
// the heavyweight SettingsModal waits for its first open.
