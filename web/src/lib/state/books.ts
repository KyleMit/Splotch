...
//
// The `.color.webp` twin is a flat-colored, pixel-aligned version of the line-art
// page (generated by scripts/gen-coloring-fills.mjs). The magic brush reveals it
// where the child paints — see ADR-0043.
//
