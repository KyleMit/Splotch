...
// Every button the panel can show: crayon, stroke width, eraser, coloring book,
// magic brush, screenshot, AI image, undo. The prerendered page sizes for this
// worst case — the server can't know a stored AI token or toggle states.
export const MAX_ACTION_BUTTON_COUNT = 8;

export function visibleActionButtonCount(): number {
  return (
    1 + // magic brush, always shown
    (settings.crayonEnabled ? 1 : 0) +
