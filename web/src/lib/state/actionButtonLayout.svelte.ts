...
// Every button the panel can show: stroke width, eraser, coloring book, brush
// selector, screenshot, AI image, undo. The prerendered page sizes for this
