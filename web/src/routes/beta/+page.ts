// This route is web-only. It explains how to install the native apps, so it is
// pointless inside one of them — and its Play Store links inside an iOS binary
// are an App Review 2.3.10 rejection, while its TestFlight invitation inside the
// app it enrolls into is simply circular.
//
...
// link, the TestFlight invitation, and the support address out of the shipped JS
// chunk.
//
