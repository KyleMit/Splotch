...
node .claude/skills/audit-page-load/run-audit.mjs

# One device / one visit:
node .claude/skills/audit-page-load/run-audit.mjs --device phone --visits first
...
`audit-page-load`, and a one-line summary (headline scores + the standout lever).
