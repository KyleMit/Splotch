...
| `drawing/opGeometry.ts`         | An op's bare geometry, shared by the renderer and the pass buffer without either importing the other: its user-space extent, the `AA_PAD` bleed convention, and the painter that lays a dot/path shape down with a caller-supplied paint.                                                                                                                                                                                                                                                                                                           |
