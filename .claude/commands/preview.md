---
description: Cloud session only — start the dev server + reverse tunnel and report the public phone-preview URL
---

Start the live phone-preview tunnel for this cloud session (ADR-0021, `docs/CLOUD.md`).
