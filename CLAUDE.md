...
| `docs/PROFILING-CAMPAIGNS.md`    | Unattended physical-device capture: the preflight, and the setup mistakes that produce plausible wrong numbers without erroring — device identity, port contention, stale builds, input cadence                                                                                                                                                                                                |
