...
| `docs/AUDIT-COMMENTS.md` | Generated archive of every per-finding comment the `burn-down-audits` runs posted to their PRs (\#535–\#589) — the durable record of what each fix did, what the adversarial reviewer caught, and why findings were dropped, since `docs/AUDIT.md` is drained as they land. The PRs stay canonical; regenerate rather than hand-edit                                                 |
