...
| `docs/STORE-DRAWINGS.md` | How store free-draw SVG authoring inputs become static named pointer-instruction functions, how colors and widths are selected, and how SVG→points→live-app fidelity is evaluated                                                                                                                                                                                                    |
