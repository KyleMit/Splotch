...
| `drawing/crayonBrush.ts`        | Deterministic crayon paint and geometry (ADR-0065): builds/caches the paper-anchored alpha tooth and converts the live centerline into replayable swept polygons whose shared joins deposit once while true crossings build coverage.                                                                                                                                                                                                     |
...
| `state/tool.svelte.ts`          | Mutually exclusive active drawing tool state: pen, crayon, eraser, or magic brush.                                                                                                                                                                                                                                                                                                                                                        |
...
* **Actions Panel** - Bottom-corner panel hosting auxiliary controls
  ...
  * **Crayon Brush Button** (`#crayonBrushButton`) - Toggles the crayon brush. It deposits the
    selected color through a deterministic paper-tooth pattern, with true same-color overdraw
    filling that tooth while remaining replay-exact (ADR-0065).
