...
| `npm run perf:ipad:release-rig`               | the ADR-0094 scheduled physical-device boundary. Fast runs two scenarios; full runs all scenarios plus unattended real-screen frames. Both require at least three independent repeats, exact build/device/OS provenance, and never accept simulator evidence                                                                                                                                                                                                                                            | a Pages-ready report directory with repeated `ipad-gates.json` and, for full, normalized `real-screen.json`                                      |
