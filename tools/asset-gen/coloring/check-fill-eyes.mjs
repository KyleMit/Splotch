...
// check-fill-drift.mjs (registration) — a fill can register perfectly and
...
//
//   npm run check:coloring-fill-eyes                 whole catalog
//   npm run check:coloring-fill-eyes -- nature       one category
//   npm run check:coloring-fill-eyes -- nature/bee-wide
