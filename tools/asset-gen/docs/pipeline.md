...
| No page frame              | minimum continuous ink coverage across the best inset line on each of all four sides (`scoreOutlineFrame`)                                                   | < 97%      | monster-truck-wide's one-pixel rectangular page border; ordinary edge-near art and three-sided enclosures stay below the bar                                                            |
