...
1. **`nature/ant-tall`'s night ant is green** *(shipped asset)*: the light fill is a proper
...
next mass regen happens. (The "nothing shipped looks wrong" framing died 2026-07-13: Tier 1 #1's
...
16. **Light↔night and tall↔wide palette coherence are unenforced (IDEAS #8/#9)** *(gate blind
    ...
    *identity* color (Tier 1 #1: the night ant turned green). The hue-flip scorers and conditioning
