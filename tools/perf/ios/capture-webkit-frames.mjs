...
//   npm run perf:ios:webkit:frames -- --phases=blank,page
//   npm run perf:ios:webkit:frames -- --contact-seconds=15
//   npm run perf:ios:webkit:frames -- --free-draw=60
//
// The sibling `npm run perf:ios:webkit:gates` drives /dev/engine and answers "how expensive
...
//
// The measuring happens in tools/perf/probes/real-screen-probe.js on the device; the
// maths is in real-screen-stats.mjs; this file is the plumbing between them.
//
// Local-only, same device prerequisites as `perf:ios:webkit:gates` (see the profiling
...
import { createTimelineCounter, timelineRows } from '../lib/timeline-records.mjs';
import {
  comparisonRows,
  engineRows,
  inputRows,
