...
// (capture-webview-session.mjs) both hand it a ready Playwright page + CDP session — the
...
import { circlePts, zigzag, arcPts } from '../../app-driver/lib/stroke-geometry.mjs';
import {
  canvasBox,
  expandDrawer,
  pickColor,
