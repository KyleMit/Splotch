...
| Orchestrated use  | None; a Claude session is always the handler                                                                           | None; a Codex session is always the handler. The handler-less publisher alias was removed in issue #2077                                                                                       |
