...
//   node tools/icons/generate-icon-names.mjs
...
const contents = `// AUTO-GENERATED by tools/icons/generate-icon-names.mjs — do not edit by hand.
// Run \`node tools/icons/generate-icon-names.mjs\` (or any dev/build) to regenerate.
