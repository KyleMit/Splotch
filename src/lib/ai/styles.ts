...
export const STYLE_SUFFIXES = {
  ...
  Paper: 'Render the final image as a 3D pop-up storybook page and layered paper cutout collage with depth shadows and textured edges.',
  Felt: 'Render the final image as a handmade felt craft scene, with fuzzy 3D fabric textures and stitched details.',
  Sticker: 'Render the final image as a bold sticker illustration with thick outlines, solid colors, and cutout white borders.',
  Cartoon: 'Render the final image as a clean digital cartoon and comic book illustration with bold lines, smooth shading, and crisp edges.',
  Pixel: 'Render the final image as a cute retro pixel art scene with simplified shapes, crisp blocks, and a vibrant, limited palette.'
