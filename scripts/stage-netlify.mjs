...
// wrote it to web/.netlify, so copy that single tree up to the root. The function's own catch-all
// route (adapter-netlify v6 V2 function: `export const config = { path: ["/*"] }`) then resolves
