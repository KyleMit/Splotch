...
- EYES must stay bright and readable, never a dark void. Keep the eye WHITE (the sclera) a light, soft off-white so it clearly reads as an eye-white, with a distinctly darker iris/pupil inside it and a tiny bright catchlight glint. NEVER fill a whole eye with a single dark color (a black-on-black or navy-on-navy eye reads as an empty socket) — the light eye-white and the dark pupil must contrast so the eyes look lively and awake, even at night. Eye-whites are one of the few areas allowed a near-white tint.
