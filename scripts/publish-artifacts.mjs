...
//
//   node scripts/publish-artifacts.mjs                 publish package.json's version
//   node scripts/publish-artifacts.mjs 1.4.0           publish a specific version
//   node scripts/publish-artifacts.mjs --only=android  just the .aab (or ios for just the .ipa)
//   node scripts/publish-artifacts.mjs --dry-run       verify versions, upload nothing
//
