...
| `drawing/crayonPassBuffer.ts`   | The crayon deposition pass's lifecycle: the per-target accumulation buffers, the live overlay + paper-space mirrors, the two-blit subtractive glaze stamp, and the pass close that captures a `crayonPassRaster` (ADR-0065/0068). `renderOp` dispatches crayon ops here.                                                                                                                                                                                                                                                                            |
...
| `drawing/foldRegions.ts`        | Pure fold-region geometry (ADR-0069): the padded, clustered, disjoint paper rects a commit's fold will mutate, which the undo snapshot capture uses to decide what to copy. No canvas or history state — boxes only.                                                                                                                                                                                                                                                                                                                                |
